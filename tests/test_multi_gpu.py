...
def test_memory_usage_multi_gpu(batch_size, gpu_id=0):
    """测试在指定GPU上的显存使用情况"""
...
def main():
    ...
    batch_sizes = [64, 128, 256, 512, 1024, 2048, 4096, 8192, 12288, 16384, 20480, 24576]
    results = []
    ...
    for batch_size in batch_sizes:
        try:
            ...
            result = test_memory_usage_multi_gpu(batch_size, test_gpu_id)
